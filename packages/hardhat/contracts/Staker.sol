...
contract Staker {
  ...
  uint256 public withdrawalDeadline = block.timestamp + 40 seconds;
  uint256 public claimDeadline = block.timestamp + 80 seconds;
  ...
  */
  ...
  function stake() public payable withdrawalDeadlineReached(false) claimDeadlineReached(false){
    ...
    require(balances[msg.sender] <= threshold, "Exceed the Threshold Value");
